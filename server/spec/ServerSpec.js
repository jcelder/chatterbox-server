...
describe('Node Server Request Listener Function', function() {
  ...
  it('should answer GET requests for /classes/messages given query parameters with a 200 status code', function() {
    var req = new stubs.request('/classes/messages/?search=cool&fun=yes', 'GET');
    var res = new stubs.response();
  ...
  it('Should respond with messages that were previously posted', function() {
    ...
    expect(messages[0].updatedAt).to.exist;
    expect(res._ended).to.equal(true);
  });
